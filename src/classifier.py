...
class Classifier():
	...
	def __init__(self):
		self.routage = {
			0:[366,367,369,370,372,373,374,375,377,378,381,382,384],
			1:[364,365,368,371,376,379,380],
           	2:[269,270,271,268,248,250,249],
			3:[277,278,279,280,272,273,274,275],
           	4:[333],
			5:[338,332,331,330],
			6:[383,281,282,283,284,285,286],
			7:[287,291,292],
           	8:[293],
			9:[290,288,289]
		}
